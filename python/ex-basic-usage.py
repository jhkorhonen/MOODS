...
matrices = [MOODS.parsers.pfm_log_odds(matrix_directory + filename, bg, pseudocount) for filename in matrix_names]
# reverse complements
matrices = matrices + [MOODS.parsers.pfm_log_odds_rc(matrix_directory + filename, bg, pseudocount) for filename in matrix_names]
